(function () {
    ...
    function CalendarUI () {
        ...
        function renderTodaysView () {
            children.todayView = new TodayViewUI(currentDate.date, currentDate.day);
            children.todayView.render(node);
        }

        function renderCalendarView () {
            children.calendarView = new CalendarViewUI(currentDate);
        ...
        function onDateClick (selectedDate) {
        ...
        function addCalendarEventManager () {
            node.addEventListener("click", function (ev) {
                ...
                if (isValidDateElement(targetEl)) {
                    onDateClick(Number(targetEl.textContent));
                } else if (isPrevButton(targetEl)) {
                    onPrevMonthClick();
                } else if (isNextButton(targetEl)) {
                    onNextMonthClick();
                }
